...
class UIKitSettings(context: Context) {
    ...
    companion object {
        ...
        var sendMessageInGroup = false
        var publicGroup: Boolean = false
        var privateGroup: Boolean = false
        var passwordGroup: Boolean = false
        ...
        var conversationInMode: ConversationMode = ConversationMode.USER
